...
static struct acpu_level acpu_freq_tbl_slow[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   925000, AVS(0x40001F) },
	{ 0, {   432000, HFPLL, 2, 0x20 }, L2(6),   950000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(6),   975000 },
	{ 0, {   540000, HFPLL, 2, 0x28 }, L2(6),  1000000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(6),  1012500 },
	{ 0, {   648000, HFPLL, 1, 0x18 }, L2(6),  1025000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(6),  1037500 },
	{ 0, {   756000, HFPLL, 1, 0x1C }, L2(6),  1050000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(6),  1062500 },
	{ 0, {   864000, HFPLL, 1, 0x20 }, L2(6),  1075000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(6),  1087500 },
	{ 0, {   972000, HFPLL, 1, 0x24 }, L2(6),  1100000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(6),  1112500 },
	...
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(18), 1212500, AVS(0x100018) },
	{ 1, {  1512000, HFPLL, 1, 0x38 }, L2(18), 1225000, AVS(0x400012) },
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_nom[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   875000, AVS(0x40007F) },
	{ 0, {   432000, HFPLL, 2, 0x20 }, L2(6),   900000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(6),   925000 },
	{ 0, {   540000, HFPLL, 2, 0x28 }, L2(6),   950000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(6),   962500 },
	{ 0, {   648000, HFPLL, 1, 0x18 }, L2(6),   975000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(6),   987500 },
	{ 0, {   756000, HFPLL, 1, 0x1C }, L2(6),  1000000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(6),  1012500 },
	{ 0, {   864000, HFPLL, 1, 0x20 }, L2(6),  1025000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(6),  1037500 },
	{ 0, {   972000, HFPLL, 1, 0x24 }, L2(6),  1050000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(6),  1062500 },
	{ 0, {  1080000, HFPLL, 1, 0x28 }, L2(18), 1075000, AVS(0x400015) },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(18), 1087500, AVS(0x400015) },
	{ 0, {  1188000, HFPLL, 1, 0x2C }, L2(18), 1100000, AVS(0x400015) },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(18), 1112500, AVS(0x400015) },
	{ 0, {  1296000, HFPLL, 1, 0x30 }, L2(18), 1125000, AVS(0x400015) },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(18), 1137500, AVS(0x400015) },
	{ 0, {  1404000, HFPLL, 1, 0x34 }, L2(18), 1150000, AVS(0x400015) },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(18), 1162500, AVS(0x100018) },
	{ 1, {  1512000, HFPLL, 1, 0x38 }, L2(18), 1175000, AVS(0x400012) },
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_fast[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   825000, AVS(0x4000FF) },
	{ 0, {   432000, HFPLL, 2, 0x20 }, L2(6),   850000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(6),   875000 },
	{ 0, {   540000, HFPLL, 2, 0x28 }, L2(6),   900000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(6),   912500 },
	{ 0, {   648000, HFPLL, 1, 0x18 }, L2(6),   925000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(6),   937500 },
	{ 0, {   756000, HFPLL, 1, 0x1C }, L2(6),   950000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(6),   962500 },
	{ 0, {   864000, HFPLL, 1, 0x20 }, L2(6),   975000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(6),   987500 },
	{ 0, {   972000, HFPLL, 1, 0x24 }, L2(6),  1000000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(6),  1012500 },
	{ 0, {  1080000, HFPLL, 1, 0x28 }, L2(18), 1025000, AVS(0x10001B) },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(18), 1037500, AVS(0x10001B) },
	{ 0, {  1188000, HFPLL, 1, 0x2C }, L2(18), 1050000, AVS(0x10001B) },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(18), 1062500, AVS(0x10001B) },
	{ 0, {  1296000, HFPLL, 1, 0x30 }, L2(18), 1075000, AVS(0x10001B) },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(18), 1087500, AVS(0x400012) },
	{ 0, {  1404000, HFPLL, 1, 0x34 }, L2(18), 1100000, AVS(0x400012) },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(18), 1112500, AVS(0x400012) },
	{ 1, {  1512000, HFPLL, 1, 0x38 }, L2(18), 1125000, AVS(0x400012) },
	{ 0, { 0 } }
};
