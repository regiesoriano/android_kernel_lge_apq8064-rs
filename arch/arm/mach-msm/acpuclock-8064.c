...
static struct l2_level l2_freq_tbl_oc1[] __initdata = {
	[0]  = { {  384000, PLL_8, 0, 0x00 },  950000, 1050000, 1 },
	[1]  = { {  432000, HFPLL, 2, 0x20 }, 1050000, 1050000, 2 },
	[2]  = { {  486000, HFPLL, 2, 0x24 }, 1050000, 1050000, 2 },
	[3]  = { {  540000, HFPLL, 2, 0x28 }, 1050000, 1050000, 2 },
...
static struct l2_level l2_freq_tbl_oc2[] __initdata = {
	[0]  = { {  384000, PLL_8, 0, 0x00 },  950000, 1050000, 1 },
	[1]  = { {  432000, HFPLL, 2, 0x20 }, 1050000, 1050000, 2 },
	[2]  = { {  486000, HFPLL, 2, 0x24 }, 1050000, 1050000, 2 },
	[3]  = { {  540000, HFPLL, 2, 0x28 }, 1050000, 1050000, 2 },
...
static struct l2_level l2_freq_tbl_oc3[] __initdata = {
	[0]  = { {  384000, PLL_8, 0, 0x00 },  950000, 1050000, 1 },
	[1]  = { {  432000, HFPLL, 2, 0x20 }, 1050000, 1050000, 2 },
	[2]  = { {  486000, HFPLL, 2, 0x24 }, 1050000, 1050000, 2 },
	[3]  = { {  540000, HFPLL, 2, 0x28 }, 1050000, 1050000, 2 },
...
static struct l2_level l2_freq_tbl_oc4[] __initdata = {
	[0]  = { {  384000, PLL_8, 0, 0x00 },  950000, 1050000, 1 },
	[1]  = { {  432000, HFPLL, 2, 0x20 }, 1050000, 1050000, 2 },
	[2]  = { {  486000, HFPLL, 2, 0x24 }, 1050000, 1050000, 2 },
	[3]  = { {  540000, HFPLL, 2, 0x28 }, 1050000, 1050000, 2 },
	...
	[8]  = { {  810000, HFPLL, 1, 0x1E }, 1150000, 1150000, 4 },
	[9]  = { {  864000, HFPLL, 1, 0x20 }, 1150000, 1150000, 4 },
	[10] = { {  918000, HFPLL, 1, 0x22 }, 1150000, 1150000, 7 },
	...
	[14] = { { 1431000, HFPLL, 1, 0x35 }, 1225000, 1225000, 7 },
	{ }
};

static struct l2_level l2_freq_tbl_oc5[] __initdata = {
	[0]  = { {  384000, PLL_8, 0, 0x00 },  950000, 1050000, 1 },
	[1]  = { {  432000, HFPLL, 2, 0x20 }, 1050000, 1050000, 2 },
	[2]  = { {  486000, HFPLL, 2, 0x24 }, 1050000, 1050000, 2 },
	[3]  = { {  540000, HFPLL, 2, 0x28 }, 1050000, 1050000, 2 },
...
static struct acpu_level tbl_slow[] __initdata = {
	...
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),  1012500 },
	{ 0, {   648000, HFPLL, 1, 0x18 }, L2(5),  1025000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(5),  1037500 },
	{ 0, {   756000, HFPLL, 1, 0x1C }, L2(5),  1050000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(5),  1062500 },
	{ 0, {   864000, HFPLL, 1, 0x20 }, L2(5),  1075000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(5),  1087500 },
	{ 0, {   972000, HFPLL, 1, 0x24 }, L2(5),  1100000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(5),  1112500 },
	{ 0, {  1080000, HFPLL, 1, 0x28 }, L2(14), 1125000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(14), 1137500 },
	{ 0, {  1188000, HFPLL, 1, 0x2C }, L2(14), 1150000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(14), 1162500 },
	{ 0, {  1296000, HFPLL, 1, 0x30 }, L2(14), 1175000 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(14), 1187500 },
	{ 0, {  1404000, HFPLL, 1, 0x34 }, L2(14), 1200000 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(14), 1212500 },
	{ 1, {  1512000, HFPLL, 1, 0x38 }, L2(14), 1225000 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_nom[] __initdata = {
	...
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),   962500 },
	{ 0, {   648000, HFPLL, 1, 0x18 }, L2(5),   975000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(5),   987500 },
	{ 0, {   756000, HFPLL, 1, 0x1C }, L2(5),  1000000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(5),  1012500 },
	{ 0, {   864000, HFPLL, 1, 0x20 }, L2(5),  1025000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(5),  1037500 },
	{ 0, {   972000, HFPLL, 1, 0x24 }, L2(5),  1050000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(5),  1062500 },
	{ 0, {  1080000, HFPLL, 1, 0x28 }, L2(14), 1075000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(14), 1087500 },
	{ 0, {  1188000, HFPLL, 1, 0x2C }, L2(14), 1100000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(14), 1112500 },
	{ 0, {  1296000, HFPLL, 1, 0x30 }, L2(14), 1125000 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(14), 1137500 },
	{ 0, {  1404000, HFPLL, 1, 0x34 }, L2(14), 1150000 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(14), 1162500 },
	{ 1, {  1512000, HFPLL, 1, 0x38 }, L2(14), 1175000 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_faster[] __initdata = {
	...
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),   887500 },
	{ 0, {   648000, HFPLL, 1, 0x18 }, L2(5),   900000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(5),   912500 },
	{ 0, {   756000, HFPLL, 1, 0x1C }, L2(5),   925000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(5),   937500 },
	{ 0, {   864000, HFPLL, 1, 0x20 }, L2(5),   950000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(5),   962500 },
	{ 0, {   972000, HFPLL, 1, 0x24 }, L2(5),   975000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(5),   987500 },
	{ 0, {  1080000, HFPLL, 1, 0x28 }, L2(14), 1000000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(14), 1012500 },
	...
	{ 0, {  1404000, HFPLL, 1, 0x34 }, L2(14), 1075500 },
...
static struct acpu_level tbl_PVS0_1512MHz[] __initdata = {
	...
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(4),   950000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),   950000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(6),   962500 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(7),  1000000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(8),  1025000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(9),  1037500 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(10), 1075000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(11), 1087500 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(12), 1125000 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(13), 1150000 },
	...
	{ 1, {  2160000, HFPLL, 1, 0x4F }, L2(14), 1337500 },
	{ 1, {  2214000, HFPLL, 1, 0x50 }, L2(14), 1350000 },
	{ 1, {  2268000, HFPLL, 1, 0x52 }, L2(14), 1375000 },
	{ 1, {  2322000, HFPLL, 1, 0x54 }, L2(14), 1400000 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS1_1512MHz[] __initdata = {
	...
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(9),  1012500 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(10), 1037500 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(11), 1050000 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(12), 1087500 },
	...
	{ 1, {  2214000, HFPLL, 1, 0x50 }, L2(14), 1337500 },
	{ 1, {  2268000, HFPLL, 1, 0x52 }, L2(14), 1350000 },
	{ 1, {  2322000, HFPLL, 1, 0x54 }, L2(14), 1375000 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS2_1512MHz[] __initdata = {
	...
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(7),   937500 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(8),   950000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(9),   975000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(10), 1000000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(11), 1012500 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(12), 1037500 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(13), 1075000 },
	...
	{ 1, {  2268000, HFPLL, 1, 0x52 }, L2(14), 1337500 },
	{ 1, {  2322000, HFPLL, 1, 0x54 }, L2(14), 1362500 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS3_1512MHz[] __initdata = {
	...
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(4),   900000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),   900000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(6),   900000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(7),   900000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(8),   925000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(9),   950000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(10),  975000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(11),  987500 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(12), 1000000 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(13), 1037500 },
	...
	{ 1, {  2268000, HFPLL, 1, 0x52 }, L2(14), 1312500 },
	{ 1, {  2322000, HFPLL, 1, 0x54 }, L2(14), 1350000 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS4_1512MHz[] __initdata = {
	...
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(7),   887500 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(8),   900000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(9),   925000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(10),  950000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(11),  962500 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(12),  975000 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(13), 1000000 },
	...
	{ 1, {  2268000, HFPLL, 1, 0x52 }, L2(14), 1275000 },
	{ 1, {  2322000, HFPLL, 1, 0x54 }, L2(14), 1300000 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS5_1512MHz[] __initdata = {
	...
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(8),   900000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(9),   925000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(10),  937500 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(11),  950000 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(12),  962500 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(13),  987500 },
	...
	{ 1, {  2268000, HFPLL, 1, 0x54 }, L2(14), 1250000 },
	{ 1, {  2322000, HFPLL, 1, 0x56 }, L2(14), 1275000 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS6_1512MHz[] __initdata = {
	...
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(11),  950000 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(12),  962500 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(13),  975000 },
...
static int __init acpuclk_8064_probe(struct platform_device *pdev)
{
	...
	if (opt_bin == 2) {
		acpuclk_8064_params.l2_freq_tbl = l2_freq_tbl_oc2;
		acpuclk_8064_params.l2_freq_tbl_size = sizeof(l2_freq_tbl_oc2);
	}

	if (opt_bin == 3) {
		acpuclk_8064_params.l2_freq_tbl = l2_freq_tbl_oc3;
		acpuclk_8064_params.l2_freq_tbl_size = sizeof(l2_freq_tbl_oc3);
	}

	if (opt_bin == 4) {
		acpuclk_8064_params.l2_freq_tbl = l2_freq_tbl_oc4;
		acpuclk_8064_params.l2_freq_tbl_size = sizeof(l2_freq_tbl_oc4);
	}

	if (opt_bin == 5) {
		acpuclk_8064_params.l2_freq_tbl = l2_freq_tbl_oc5;
		acpuclk_8064_params.l2_freq_tbl_size = sizeof(l2_freq_tbl_oc5);
	}
